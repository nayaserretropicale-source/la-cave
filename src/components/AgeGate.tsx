...
export default function AgeGate() {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-zinc-950 px-6">
      <div className="w-full max-w-sm rounded-2xl border border-zinc-800 bg-zinc-900 p-6 text-center text-zinc-100">
        ...
        {status === "ask" ? (
          <>
            ...
            <button onClick={accept} className="mt-5 w-full rounded-lg bg-amber-600 px-4 py-2.5 font-medium text-zinc-950 transition hover:bg-amber-500">
